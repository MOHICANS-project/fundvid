...
#include "../../src/demo/cmdLine.h"
#include "../../src/demo/libImage/image.hpp"
#include "../../src/demo/libImage/image_drawing.hpp"
#include "../../src/demo/libImage/image_io.hpp"
#include "../../src/demo/siftMatch.hpp"
#include "../../src/demo/warping.hpp"
#include "../../src/extras/sift/library.h"
#include "../../src/libOrsa/fundamental_model.hpp"
#include "../../src/extras/libNumerics/numerics.h"
...
{
    return Match(m.x2,m.y2,m.x1,m.y1,m.dist);
}
...
int main(int argc, char **argv)
{
 ...
 if(argc!=5 && argc!=6 && argc!=7 && argc!=8) {
  ...
  if(cmd.used('r')) {
	  ...
	  keypointslist keyp0;
  	  keypointslist keyp1;
      SIFT(image1Gray, image2Gray, vec_matchings,keyp0,keyp1,fSiftRatio);
  }
